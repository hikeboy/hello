...
public class S8StringToIntegerAtoi{
      public static void main(String[] args) {
          Solution solution = new S8StringToIntegerAtoi().new Solution();
...
//            int temp = result * 10 + (str.charAt(i) - '0') * flag;
//          if (result * 10 / 10 != result) { 无法通过用例 "2147483648") == 2147483647 注意与第七题整数翻转的不同
//            int a = temp -  (str.charAt(i) - '0') * flag; 也不对
//            if ( a / 10 != result ) {
